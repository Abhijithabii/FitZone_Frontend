    ...
    <div>
      <div className='  w-screen h-screen'>
        <div className='flex justify-center'>
          <form onSubmit={handleSubmit} className='mt-36 border-2  p-8 rounded-xl shadow-2xl bg-white flex flex-col items-center' action="">
            <h3 className='text-3xl text-center font-black py-6 mb-12'>Please Fill the OTP</h3>
