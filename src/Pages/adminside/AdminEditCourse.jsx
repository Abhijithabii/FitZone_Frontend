  ...
  const fetchCourseDetail = async () => {
    try {
      const response = await axios.get(
        `${BACKEND_BASE_URL}/adminside/coursemanage/${courseId}/`
      );
        ...
        <div className="w-1/2 border-2 flex justify-center pt-5 shadow-2xl rounded-xl h-3/4 ">
          ...
          >
            ...
            <div className="col-span-2">
              ...
              {imagePreviewUrl ? (
                <div
                  className="py-3 px-4 pb-28 object-contain bg-gray-500"
                  style={{
                ...
                <div
                  className="py-3 px-4 pb-28 bg-gray-500"
                  style={{
                    backgroundImage: `url(${BACKEND_BASE_URL}${courseImage})`,
