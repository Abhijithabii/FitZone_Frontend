...
function AdminSidebar() {
  ...
  useEffect(() => {
    ...
    const Menus = [
        ...
        { title: "Courses", spacing: true, icon: <GiWhiteBook/>, path: "/admincourses" },
  ...
  return (
    <div className='flex'>
        <div className={`bg-dark-purple h-screen z-auto p-6 pt-8 ${ open ? "w-72" : "w-20" } duration-300 relative `}>
            <AiOutlineMenuFold className={` bg-white text-3xl text-dark-purple 
