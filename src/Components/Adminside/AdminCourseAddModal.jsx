...
function AdminCourseAddModal({ onCourseAdded }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!courseName || !description || !courseFee || !selectedImage) {
      toast.error("OOppss....You Missed To Fill Some Fields", {
        duration: 3000,
      });
      return;
    }
    ...
    <div>
      ...
      <div
        className={`modal z-50 backdrop-blur-sm border-2 p-5 rounded-2xl ${
          isModalOpen
            ? "flex justify-center items-center fixed top-1/2 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto sm:inset-0 h-[calc(100%-1rem)] max-h-full"
            : "hidden"
        }`}
      >
        ...
        <div className="modal-container">
          <div className="modal-content p-20 border-green-500 rounded-3xl border-2">
            <h3 className="text-3xl text-center font-black text-gray-900 dark:text-black mb-4">
              Add New Course
            </h3>
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                <label
                  htmlFor="description"
                  className="  font-black block text-gray-700 dark:text-black"
                >
                  Description
                </label>
                <textarea
              ...
              <div className="mb-4">
                <label
                  htmlFor="courseImage"
                  className="block  font-black text-gray-700 dark:text-white"
                >
                  Course Image
                </label>
                <input
