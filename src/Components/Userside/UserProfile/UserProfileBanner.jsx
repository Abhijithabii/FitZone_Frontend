      ...
      <div>
        <figure className="relative h-80 w-full">
            ...
            <div className='flex flex-col items-center border-2 bg-gray-100'>
              <Avatar className='absolute border-4 top-64 w-32 h-32' src={userProfile && userProfile.image ? `${BACKEND_BASE_URL}${userProfile.image}` : "https://img.freepik.com/free-icon/user_318-159711.jpg"} alt="avatar" size="xxl" />
